...
<div><img id='cover-img'  class='img-rounded' src='../cover/$user_cover' alt='cover_pic'> 
...
<center>
<p>Click<strong>and then click the<br> <strong>Update Cover</strong> </strong></p>
...
<label class='btn btn-primary bg-green' id='update_profile'  >Select Profile
...
if(isset($_POST['submit'])){
  ...
  $random_number = rand(1,100);
    ...
    exit();
     ...
     if($run){
       echo "<script>alert('Your Cover picture is updated!')</script>";
       echo "<script>window.open('profile.php?u_id=$user_id', '_self')</script>";
     }
    }
...
if(isset($_POST['update'])){
  ...
  $random_number = rand(1,100);
    ...
    exit();
     ...
     if($run){
       echo "<script>alert('Your Profile Picture is set')</script>";
       echo "<script>window.open('profile.php?u_id=$user_id', '_self')</script>";
     }
    }
...
<?php
  ...
  <p><strong>User Status: </strong> $user_role </p>
 ...
 <?php
   ...
   while($row_posts = mysqli_fetch_array($run_posts)){
    ...
    if($content == "No"  && strlen($upload_image)>= 1){
      ...
      <h4><small style='color: #000000;'>Updated a post on <strong>$post_date</strong></small></h4>
      ...
      <button class='btn btn-success'>View</button> 
       ...
       <a href='../functions/edit_post.php?post_id' style='float:right;'>
      ...
      <button class='btn btn-success'>View</button> 
       ...
       <a href='../functions/edit_post.php?post_id=$post_id' style='float:right;'>
      <button class='btn btn-info'>Edit</button> 
       </a>
       <a href='../functions/delete_post.php?post_id=$post_id' style='float:right;'>
       <button class='btn btn-danger'>Delete</button> </a>
      ...
      $get_user = "select * from userssss where user_email='$user'";
      ...
      if($u_email != $user_email){
        echo "<script>window.open('profit.php?u_id=$user_id','_self')</script>";
      }else{
         echo"
      <a href='single.php?post_id' style='float:right;'>
      <button class='btn btn-success'>View</button> 
       </a>
       <a href='../functions/edit_post.php?post_id' style='float:right;'>
      <button class='btn btn-info'>Edit</button> 
